...
class Training_file:
    def __init__(self):
        root = Toplevel()
        root.title("Speaker Recognition - Add User")
        ...
        user_label = Label(root, fg="black", text="File name")
        ...
        user_label = Label(root, fg="black", text="Duration(sec)")
        user_label.config(font=("Courier", 20))
        ...
        rec_button = Button(root, fg="white", background="green", activebackground="green",font=("Helvetica",20,'bold italic'), activeforeground="orange", text='Record', padx=10, pady=10, command = self.reco)
		
        rec_button.place(relx=0.4, rely=0.6, anchor=CENTER)

        play_button = Button(root, fg="white", background="green", activebackground="green",font=("Helvetica",20,'bold italic'), activeforeground="orange", text='Play', padx=10, pady=10, command = self.play)
        play_button.place(relx=0.51, rely=0.6, anchor=CENTER)

        train_button = Button(root, fg="white", background="green", activebackground="green",font=("Helvetica",20,'bold italic'), activeforeground="orange", text='Train', padx=10, pady=10, command = self.train)
        train_button.place(relx=0.61, rely=0.6, anchor=CENTER)
